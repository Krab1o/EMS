...
def upgrade():
    op.create_table(
        ...
        sa.Column(
            "vote", sa.Boolean(), nullable=False, comment="Голос пользователя"
        ),
        sa.Column(
            "created_at",
        ...
        sa.ForeignKeyConstraint(
            ["event_id"],
            ["events.id"],
            name=op.f("fk_users_voted_events_event_id_events"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["user_id"],
            ["users.id"],
            name=op.f("fk_users_voted_events_user_id_users"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint(
            "user_id", "event_id", name=op.f("pk_users_voted_events")
        ),
...
def downgrade():
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["event_id"],
            ["events.id"],
            name="fk_users_liked_events_event_id_events",
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["user_id"],
            ["users.id"],
            name="fk_users_liked_events_user_id_users",
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint(
            "user_id", "event_id", name="pk_users_liked_events"
        ),
