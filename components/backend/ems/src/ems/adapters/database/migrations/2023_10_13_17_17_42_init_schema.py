...
def upgrade():
    op.create_table(
        ...
        sa.Column(
            "title", sa.String(length=256), nullable=False, comment="Название"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "first_name", sa.String(length=128), nullable=False, comment="Имя"
        ),
        sa.Column(
            "middle_name",
            sa.String(length=128),
        ...
        sa.Column(
            "course", sa.Integer(), nullable=True, comment="Номер курса"
        ),
        sa.Column(
            "group", sa.Integer(), nullable=True, comment="Номер группы"
        ),
        sa.Column(
            "role", sa.String(length=64), nullable=False, comment="Роль"
        ),
        sa.Column(
            "telegram",
            sa.String(length=128),
        ...
        sa.Column(
            "vk", sa.String(length=128), nullable=True, comment="Ссылка на VK"
        ),
        sa.Column(
            "phone_number",
            sa.String(length=32),
    ...
    op.create_table(
        ...
        sa.Column(
            "status", sa.String(length=64), nullable=False, comment="Статус"
        ),
        sa.Column(
            "place",
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["event_id"],
            ["events.id"],
            name=op.f("fk_users_enrolled_in_events_event_id_events"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["user_id"],
            ["users.id"],
            name=op.f("fk_users_enrolled_in_events_user_id_users"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint(
            "user_id", "event_id", name=op.f("pk_users_enrolled_in_events")
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["event_id"],
            ["events.id"],
            name=op.f("fk_users_liked_events_event_id_events"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["user_id"],
            ["users.id"],
            name=op.f("fk_users_liked_events_user_id_users"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint(
            "user_id", "event_id", name=op.f("pk_users_liked_events")
        ),
